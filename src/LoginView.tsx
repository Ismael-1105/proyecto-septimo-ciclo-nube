...
import { Fingerprint, ChalkboardTeacher, Eye, EyeSlash } from '@phosphor-icons/react';
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {onForgotPassword && (
              <button
                ...
                className="w-full text-[11px] font-semibold text-zinc-400 dark:text-zinc-500 hover:text-accent-600 dark:hover:text-accent-400 transition-all"
              >
          ...
          <div className="mt-6 pt-5 border-t border-zinc-100 dark:border-zinc-800">
            <p className="text-[10px] text-zinc-400 dark:text-zinc-500 text-center font-medium">
              Acceso solo para docentes — usa <span className="font-mono text-accent-500">docente@faceaccess.lab</span>
            </p>
          </div>
        </div>
      </motion.div>
